...
function findAllLocalidad(req: Request, res: Response) {
  res.json({ data: repository.findAll() });
}

function findOneLocalidad(req: Request, res: Response) {
...
function addLocalidad(req: Request, res: Response) {
...
function updateLocalidad(req: Request, res: Response) {
...
function removeLocalidad(req: Request, res: Response) {
  const id = req.params.id;
